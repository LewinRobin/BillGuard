...
const RISK_LABELS: Record<AnomalyLevel, string> = {
  none: 'Clear', low: 'Low risk', medium: 'Medium risk', high: 'High risk',
};
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F7F8FA' }}>
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={() => fetchBills(true)} tintColor="#1A6B4A" />
        }
        ListHeaderComponent={
          <View>
            {/* Header */}
            ...
            <View style={{
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, color: '#9CA3AF', marginBottom: 6, fontWeight: '500' }}>
                  TOTAL SPENT
                </Text>
                <Text style={{ fontSize: 20, fontWeight: '700', color: '#111827' }}>
              ...
              <View style={{
                ...
                <Text style={{ fontSize: 11, color: '#9CA3AF', marginTop: 4 }}>
                  {highRiskCount > 0 ? `${highRiskCount} high-risk bill${highRiskCount !== 1 ? 's' : ''}` : 'all clear'}
                </Text>
              </View>
            </View>
